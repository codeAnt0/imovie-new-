...
<body>
	...
	<div class="top2">
		<div class="logo">
			<img src="/Public/Admin/images/admin_logo.png" onClick="openurl('<?php echo U("/Public/Home/Index/index");?>');" title="在哪儿" />
		</div>
		<div class="title" >
			<h3>网站后台管理系统</h3>
		</div>
           ...
           <div class="div2">
			...
			<div class="div3">
				<li><a class="a" href="javascript:void(0);"
					onClick="openurl('<?php echo U("Movie/movieList");?>');">电影列表</a></li>
				<li><a class="a" href="javascript:void(0);"
					onClick="openurl('<?php echo U("Movie/movieAdd");?>');">添加电影</a></li>
			...
			<a class="a1" href="<?php echo U('Index/index');?>"><div class="div2">
					<div class="tcht"></div>
					退出后台
				</div></a>
		</div>
