...
<body>
<br>
 <font color="#777777"><strong>请填写下载链接：</strong></font>
<form action="<?php echo U('downloadModify');?>" method="post" class="definewidth m20" enctype="multipart/form-data">
<table class="table table-bordered table-hover m10" style="margin-left:10px;margin-top:3px;">
   ...
   <br>
    ...
    <tr>
        ...
        <td><input type="text" name="download_moviename" value="<?php echo ($form_data["download_moviename"]); ?>" /></td>
    </tr>
	<tr>
        <td class="tableleft">下载链接</td>
        <td><input type="text" name="download_link" value="<?php echo ($form_data["download_link"]); ?>" /></td>
    </tr>
    <tr>
    <td>    
    <input type="hidden" name="download_id" value="<?php echo ($form_data["download_id"]); ?>" />
    </td>
    </tr>
</table>
<br>
