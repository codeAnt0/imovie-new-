...
<link rel="stylesheet" type="text/css" href="/Public/Admin/css/style_login.css" tppabs="css/style.css" />
<style>
...
<img id="logo" src="/Public/Admin/images/logo.png" onClick="openurl('<?php echo U("/Public/Home/Index/index");?>');">
